...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(employeeService, jwtService) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.employeeService.getEmployeeByUsernameOrEmail(loginDto.email)];
                        case 1:
                            user = _a.sent();
                            ...
                            return [2 /*return*/, { token: token, employee: user }]; // Trả về cả token và thông tin nhân viên
                    }
                });
            });
        };
