        ...
        AuthController_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.validateUser(loginDto)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, { accessToken: result.token, employee: result.employee }]; // Đảm bảo trả về đúng thông tin
                    }
                });
            });
        };
