...
var UpdateProgressDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _progressName_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'Tên tiến độ công việc phải là chuỗi' }), (0, class_validator_1.MaxLength)(100, { message: 'Tên tiến độ công việc không được quá 100 ký tự' })];
            _projectid_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)({ message: 'projectid phải là ObjectId hợp lệ' })];
            _progressCategory_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)({ message: 'progressCategory phải là ObjectId hợp lệ' })];
            _progressStart_decorators = [(0, class_validator_1.IsOptional)()];
            _progressEnd_decorators = [(0, class_validator_1.IsOptional)()];
            ...
            _taskAssignPerson_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)({ message: 'taskAssignPerson phải là ObjectId hợp lệ' })];
            _taskRecipient_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsMongoId)({ message: 'taskRecipient phải là ObjectId hợp lệ' })];
            ...
            _description_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'Mô tả tiến độ công việc phải là chuỗi' }), (0, class_validator_1.MaxLength)(500, { message: 'Mô tả tiến độ công việc không được quá 500 ký tự' })];
            _status_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'Trạng thái phải là chuỗi' }), (0, class_validator_1.MaxLength)(50, { message: 'Trạng thái không được quá 50 ký tự' })];
