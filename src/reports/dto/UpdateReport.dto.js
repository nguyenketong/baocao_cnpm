...
var UpdateReportDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _reportName_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'Tên báo cáo phải là chuỗi' }), (0, class_validator_1.MaxLength)(100, { message: 'Tên báo cáo không được quá 100 ký tự' })];
            _submission_time_decorators = [(0, class_validator_1.IsOptional)()];
            ...
            _id_employee_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'ID nhân viên phải là chuỗi ObjectId hợp lệ' })];
