...
var progressCategories_service_1 = require("./progressCategories.service");
var progressCategories_controller_1 = require("./progressCategories.controller");
var ProgressCategoryModule = function () {
    ...
    var _classThis;
    var ProgressCategoryModule = _classThis = /** @class */ (function () {
        function ProgressCategoryModule_1() {
        }
        return ProgressCategoryModule_1;
    }());
    __setFunctionName(_classThis, "ProgressCategoryModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ProgressCategoryModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProgressCategoryModule = _classThis;
}();
