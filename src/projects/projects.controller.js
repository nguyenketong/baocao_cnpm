...
var ProjectController = function () {
    ...
    var ProjectController = _classThis = /** @class */ (function () {
        ...
        // Tạo mới một 
        ProjectController_1.prototype.createProject = function (createProjectDto, file) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (file) {
                                createProjectDto.projectImage = "/uploads/projectImage/".concat(file.filename);
                            }
                            return [4 /*yield*/, this.projectService.createProject(createProjectDto)];
                        case 1:
                            newProject = _a.sent();
                            return [2 /*return*/, { success: true, data: newProject }];
                    }
                });
            });
        };
        // Lấy danh sách nhân viên
        ProjectController_1.prototype.getAllProjects = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.projectService.getAllProjects()]; // Lấy danh sách nhân viên
                });
            });
        };
        // Lấy thông  theo ID
        ProjectController_1.prototype.getProjectById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.projectService.getProjectById(id)];
                });
            });
        };
        // Cập nhật thông tin 
        ProjectController_1.prototype.updateProject = function (id, updateProjectDto, file) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (file) {
                        updateProjectDto.projectImage = "/uploads/projectImage/".concat(file.filename);
                    }
                    return [2 /*return*/, this.projectService.updateProject(id, updateProjectDto)];
                });
            });
        };
        // Xóa nhân viên
        ProjectController_1.prototype.deleteProject = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.projectService.deleteProject(id)];
                });
            });
        };
    ...
    (function () {
        ...
        _createProject_decorators = [(0, common_1.Post)(), (0, common_1.UsePipes)(new common_1.ValidationPipe()), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('projectImage', {
        ...
        _getAllProjects_decorators = [(0, common_1.Get)()];
        _getProjectById_decorators = [(0, common_1.Get)(':id')];
        _updateProject_decorators = [(0, common_1.Patch)(':id'), (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('projectImage', {
                storage: (0, multer_1.diskStorage)({
        ...
        _deleteProject_decorators = [(0, common_1.Delete)(':id')];
