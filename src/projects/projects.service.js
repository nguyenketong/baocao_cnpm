...
var ProjectService = function () {
    ...
    var ProjectService = _classThis = /** @class */ (function () {
        function ProjectService_1(projectModel, projectCategoryService, notificationService, employeeService, projectFactory, dbConnection) {
        ...
        ProjectService_1.prototype.ensureConnection = function () {
        ...
        // ✅ Tạo mới Project
        ProjectService_1.prototype.createProject = function (createProjectDto) {
            return __awaiter(this, void 0, void 0, function () {
                var newProject;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.projectFactory.create(createProjectDto)];
                        case 2:
                            newProject = _a.sent();
        ...
        ProjectService_1.prototype.getAllProjects = function () {
            return __awaiter(this, void 0, void 0, function () {
                var projects;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.projectFactory.getAll()];
                        case 2:
                            projects = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.projectFactory.getById(id)];
                        case 2:
                            project = _a.sent();
        ...
        // ✅ Cập nhật Project
        ProjectService_1.prototype.updateProject = function (id, updateProjectDto) {
            return __awaiter(this, void 0, void 0, function () {
                var updatedProject;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.projectFactory.update(id, updateProjectDto)];
                        case 2:
        ...
        // ✅ Xóa Project
        ProjectService_1.prototype.deleteProject = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.ensureConnection()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/, this.projectFactory.delete(id)];
                    }
                });
            });
        };
