...
var CreateProjectDto = function () {
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _projectName_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Tên dự án là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Tên dự án phải là chuỗi' }), (0, class_validator_1.MaxLength)(100, { message: 'Tên dự án không được quá 100 ký tự' })];
            _projectCategory_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'projectCategory phải là chuỗi ObjectId hợp lệ' })];
            _projectImage_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'Ảnh hồ sơ phải là chuỗi' }), (0, class_validator_1.MaxLength)(255, { message: 'Đường dẫn ảnh hồ sơ không được quá 255 ký tự' })];
            _projectStart_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Ngày bắt đầu dự án là bắt buộc' })];
            _projectEnd_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Ngày kết thúc dự án là bắt buộc' })];
            ...
            _assignedPerson_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'employee_id phải là chuỗi ObjectId hợp lệ' })];
            _budget_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Ngân sách là bắt buộc' })];
            ...
            _description_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Mô tả dự án là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Mô tả phải là chuỗi' }), (0, class_validator_1.MaxLength)(500, { message: 'Mô tả dự án không được quá 500 ký tự' })];
