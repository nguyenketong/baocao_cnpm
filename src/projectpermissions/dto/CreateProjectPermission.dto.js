...
var CreateProjectPermissionsDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateProjectPermissionsDto() {
            ...
            return CreateProjectPermissionsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _resourceName_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Tên tài nguyên là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Tên tài nguyên phải là chuỗi' })];
