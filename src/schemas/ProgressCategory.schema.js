...
var ProgressCategory = function () {
    ...
    var ProgressCategory = _classThis = /** @class */ (function (_super) {
        __extends(ProgressCategory_1, _super);
        function ProgressCategory_1() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.progressCategoryName = __runInitializers(_this, _progressCategoryName_initializers, void 0);
            __runInitializers(_this, _progressCategoryName_extraInitializers);
            return _this;
        }
        return ProgressCategory_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ProgressCategory");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _progressCategoryName_decorators = [(0, mongoose_1.Prop)({ required: true, trim: true })];
        ...
        ProgressCategory = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProgressCategory = _classThis;
}();
