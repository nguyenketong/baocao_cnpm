...
var CreateNotificationSentDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            return CreateNotificationSentDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _notification_name_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Tên thông báo là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Tên thông báo phải là chuỗi' }), (0, class_validator_1.MaxLength)(100, { message: 'Tên thông báo không được quá 100 ký tự' })];
...
exports.CreateNotificationSentDto = CreateNotificationSentDto;
