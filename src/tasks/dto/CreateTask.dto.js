...
var CreateTaskDto = function () {
    ...
    return _a = /** @class */ (function () {
            function CreateTaskDto() {
                ...
                this.progressId = (__runInitializers(this, _taskName_extraInitializers), __runInitializers(this, _progressId_initializers, void 0));
                this.taskCategory = (__runInitializers(this, _progressId_extraInitializers), __runInitializers(this, _taskCategory_initializers, void 0));
        ...
        (function () {
            ...
            _taskName_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Tên nhiệm vụ là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Tên nhiệm vụ phải là chuỗi' }), (0, class_validator_1.MaxLength)(100, { message: 'Tên nhiệm vụ không được quá 100 ký tự' })];
            _progressId_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'progressId phải là chuỗi ObjectId hợp lệ' })];
            _taskCategory_decorators = [(0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)({ message: 'taskCategory phải là chuỗi ObjectId hợp lệ' })];
            _taskStart_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Ngày bắt đầu nhiệm vụ là bắt buộc' })];
            _taskEnd_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Ngày kết thúc nhiệm vụ là bắt buộc' })];
            ...
            _priority_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Mức độ ưu tiên là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Mức độ ưu tiên phải là chuỗi' })];
            _description_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Mô tả nhiệm vụ là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Mô tả nhiệm vụ phải là chuỗi' })];
            _status_decorators = [(0, class_validator_1.IsNotEmpty)({ message: 'Trạng thái nhiệm vụ là bắt buộc' }), (0, class_validator_1.IsString)({ message: 'Trạng thái nhiệm vụ phải là chuỗi' })];
