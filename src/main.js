...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, uploadDir, employeeProfileDir, projectImageDir;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    uploadDir = 'uploads';
                    employeeProfileDir = path.join(uploadDir, 'employeeProfile');
                    projectImageDir = path.join(uploadDir, 'projectImage');
                    ...
                    if (!fs.existsSync(employeeProfileDir)) {
                        ...
                        console.log("\uD83D\uDCC2 Created directory: ".concat(employeeProfileDir));
                    }
                    if (!fs.existsSync(projectImageDir)) {
                        fs.mkdirSync(projectImageDir);
                        console.log("\uD83D\uDCC2 Created directory: ".concat(projectImageDir));
                    }
                    // Configure CORS
                    app.enableCors({
