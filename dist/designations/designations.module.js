...
exports.DesignationModule = DesignationModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [designations_controller_1.DesignationController],
        providers: [designations_service_1.DesignationService],
        exports: [designations_service_1.DesignationService, mongoose_1.MongooseModule],
    })
], DesignationModule);
