...
var CreateTeamItem = function (_a) {
    ...
    var _c = (0, react_1.useState)([]), projects = _c[0], setProjects = _c[1];
    ...
    var onSubmit = function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var teamData, response, newTeamId, memberError_1, error_2;
        var _a, _b, _c;
            ...
            switch (_d.label) {
                ...
                case 9:
                    ...
                    if (axios_1.default.isAxiosError(error_2)) {
                        react_toastify_1.toast.error(((_b = (_a = error_2.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || 'Error creating team');
                        console.error('API Error:', (_c = error_2.response) === null || _c === void 0 ? void 0 : _c.data);
                    }
                    else {
...
exports.default = CreateTeamItem;
