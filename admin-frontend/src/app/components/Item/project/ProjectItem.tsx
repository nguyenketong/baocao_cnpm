...
const ProjectItem: React.FC<ProjectItemProps> = ({ project }) => {
  const { isEditModalOpen, setIsEditModalOpen, handleAddProgress, handleEdit } =
    useProjectActions(project._id);
    ...
    <div className=" rounded-xl shadow-md p-4 ">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="flex gap-1">
          <button
            onClick={handleEdit}
            className="p-1.5 text-blue-500 hover:bg-blue-50 rounded-lg transition-colors duration-200"
          >
      ...
      <div className="space-y-2 ">
        ...
        <button
          ...
          className="w-full mt-2 px-3 py-1.5 bg-green-500 text-white text-xs rounded-lg hover:bg-green-600 transition duration-200"
        >
          Thêm tiến độ
        </button>
      </div>
