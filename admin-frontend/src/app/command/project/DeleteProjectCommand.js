...
var DeleteProjectCommand = /** @class */ (function () {
    function DeleteProjectCommand(projectId, onSuccess) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.delete("http://localhost:3000/projects/".concat(this.projectId))];
                    case 1:
                        _a.sent();
                        this.onSuccess();
                        return [3 /*break*/, 3];
                    case 2:
                        error_1 = _a.sent();
                        console.error('Lỗi khi xóa dự án:', error_1);
                        return [3 /*break*/, 3];
