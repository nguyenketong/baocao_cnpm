...
var DepartmentItem_1 = require("../../components/Item/DepartmentItem");
...
function DepartmentList() {
    ...
    var fetchDepartments = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, departmentService_1.getDepartments)()];
                case 1:
                    data = _a.sent();
                    setDepartments(data);
                    return [2 /*return*/];
    ...
    var handleAdd = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!name.trim()) {
                        react_toastify_1.toast.error("Tên phòng ban không được để trống!");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, (0, departmentService_1.createDepartment)(name)];
                case 1:
                    _a.sent();
                    react_toastify_1.toast.success("Thêm phòng ban thành công!");
                    setName("");
                    fetchDepartments();
                    return [2 /*return*/];
            }
    ...
    var handleDelete = function (id) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, departmentService_1.deleteDepartment)(id)];
                case 1:
                    _a.sent();
                    react_toastify_1.toast.success("Xóa phòng ban thành công!");
                    fetchDepartments();
                    return [2 /*return*/];
            }
        });
    ...
    var handleEditClick = function (id) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, departmentService_1.getDepartmentById)(id)];
                case 1:
                    department = _a.sent();
                    setEditId(id);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, departmentService_1.updateDepartment)(editId, editName)];
                case 1:
                    _a.sent();
                    react_toastify_1.toast.success("Cập nhật phòng ban thành công!");
                    setEditId(null);
                    setEditName("");
                    fetchDepartments();
                    return [2 /*return*/];
    ...
    return (<div className="p-6">
      ...
      {/* Form thêm mới */}
      <div className="mb-4">
        <input type="text" value={name} onChange={function (e) { return setName(e.target.value); }} className="border p-2 rounded mr-2" placeholder="Nhập tên phòng ban"/>
      ...
      {editId && (<div className="mb-4">
          ...
          <Button_1.Button label="Chỉnh sửa" onClick={handleUpdate} variant="primary" icon={<fi_1.FiEdit />}/>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {departments.map(function (dept) { return (<DepartmentItem_1.default key={dept._id} department={dept} onDelete={handleDelete} onEdit={handleEditClick}/>); })}
      </div>
    </div>);
}
