...
var projectpmCommand_1 = require("@/app/command/projectpmCommand"); // Import các hàm từ command file
...
var ProjectEmployeeList = function () {
    ...
    (0, react_1.useEffect)(function () {
        ...
        var fetchProfileAndProjects = function () { return __awaiter(void 0, void 0, void 0, function () {
            var employeeData, projectsData, filteredProjects, err_1;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                        return [4 /*yield*/, (0, projectpmCommand_1.fetchEmployeeById)(employeeId)];
                    case 1:
                        employeeData = _b.sent();
                        setEmployee(employeeData);
                        if (!(((_a = employeeData.designation_id) === null || _a === void 0 ? void 0 : _a.designationName) === "IT Project Manager")) return [3 /*break*/, 3];
                        return [4 /*yield*/, (0, projectpmCommand_1.fetchProjectsForPM)(employeeId)];
                    case 2:
                        projectsData = _b.sent();
                        filteredProjects = (0, projectpmCommand_1.filterProjectsByAssignedPerson)(projectsData, employeeId);
    ...
    return (<main className="container mx-auto px-4">
      ...
      <div className="row g-3 gy-5 py-3 row-deck">
        {projects.length > 0 ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
