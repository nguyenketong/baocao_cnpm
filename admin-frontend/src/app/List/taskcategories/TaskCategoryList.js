...
exports.default = TaskCategoryList;
var react_1 = require("react");
var react_toastify_1 = require("react-toastify");
require("react-toastify/dist/ReactToastify.css");
var taskCategoryService_1 = require("../../services/taskCategoryService"); // Thay tên service thành taskCategoryService
var TaskCategoryItem_1 = require("../../components/Item/task/TaskCategoryItem"); // Thay tên component thành TaskCategoryItem
function TaskCategoryList() {
    var _this = this;
    var _a = (0, react_1.useState)([]), taskCategories = _a[0], setTaskCategories = _a[1];
    ...
    var fetchTaskCategories = function () { return __awaiter(_this, void 0, void 0, function () {
        var data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, taskCategoryService_1.getTaskCategory)()];
                case 1:
                    data = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, taskCategoryService_1.create)(name)];
                case 1:
                    _a.sent();
    ...
    var handleDelete = function (id) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, taskCategoryService_1.deleteTaskCategory)(id)];
                case 1:
                    _a.sent();
    ...
    var handleEditClick = function (id) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, taskCategoryService_1.getTaskCategoryById)(id)];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, taskCategoryService_1.updateTaskCategory)(editId, editName)];
                case 1:
                    _a.sent();
    ...
    return (<div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {taskCategories.map(function (taskCategory) { return (<TaskCategoryItem_1.default key={taskCategory._id} taskCategory={taskCategory} // Đổi projectCategory thành taskCategory
