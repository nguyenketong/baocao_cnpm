...
var TeamItemMember_1 = require("../../components/Item/teammember/TeamItemMember");
...
var TeamListMember = function () {
    var _a;
    var _b = (0, react_1.useState)(''), searchTerm = _b[0], setSearchTerm = _b[1];
    var _c = (0, react_1.useState)([]), currentUserTeams = _c[0], setCurrentUserTeams = _c[1];
    ...
    var fetcher = function (url) { return __awaiter(void 0, void 0, void 0, function () {
        var token, employee, response, employeeTeamIds_1, memberTeams, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    response = _b.sent();
                    employeeTeamIds_1 = ((_a = employee.team_id) === null || _a === void 0 ? void 0 : _a.map(function (team) { return team._id; })) || [];
                    memberTeams = response.data.filter(function (team) {
                        return employeeTeamIds_1.includes(team._id);
                    });
                    setCurrentUserTeams(memberTeams);
                    return [2 /*return*/, memberTeams];
                case 2:
                    error_1 = _b.sent();
                    throw error_1;
            ...
            <div className="flex flex-col justify-end">
                <div className="flex justify-between items-center w-full h-full p-8 bg-[#f0f0f0] rounded-xl mb-4 border-b-2 pb-0">
                    <h2 className="page-title text-4xl font-bold mb-6" id="title">
                        Danh sách nhóm của {(_a = getCurrentEmployee()) === null || _a === void 0 ? void 0 : _a.employeeName}
                    </h2>
                ...
                <div className="bg-[#f0f0f0] p-8 rounded-xl">
                    <div className="grid-wrapper gap-10">
                        <div className="teams-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4" id="team-card">
                            {filteredTeams.length ? (filteredTeams.map(function (team) { return (<TeamItemMember_1.default key={team._id} team={team} hideDelete={true} hideEdit={true} hideAddMember={true}/>); })) : (<div className="empty-state">
...
exports.default = TeamListMember;
